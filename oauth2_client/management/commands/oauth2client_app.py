"""
Oauth2 Client Application creation from CLI.
"""
import json

from labsterutils.django.model import help_text
from labsterutils.oauth2.management.commands.oauth2_app_maker import OAuth2AppMaker
from oauth2_client.models import Application as AppModel


class Command(OAuth2AppMaker):
    """
    ...
    def app_model(cls):
        """
        Application model class to be used
        """
        return AppModel

    def add_arguments(self, parser):
        """
        Properties of an Application object. Use help messages defined on the model. Follow a
        convention that `argument name == model property name`
        """
