...
class MobileApplicationAdapter:
    """
    An adapter class to expose Application for the mobile_auth package in LTI repo.
    """
...
class AccessToken(models.Model):
    ...
    def to_client_dict(self):
        """
        Transform this AccessToken to a dict as expected by the oauth2_client.OAuth2Client
